...
import { Modal, View, SafeAreaView, Image ,Text, StyleSheet, TouchableOpacity, ScrollView, Share } from 'react-native';
    ...
    return(
        <SafeAreaView style={styles.container}>
            <Image
                resizeMode='cover'
                style={styles.cover}
                source={{ uri: `http://192.168.0.14:1337${post?.attributes?.cover?.data?.attributes?.url}` }}
            />
            ...
            <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                ...
                {links.length > 0 && (
                    <Text sytle={styles.subTitle}>Links</Text>
                )}
